...
struct Sobel : public sc_module {
    ...
    sc_signal< sc_logic > grp_Filter2D_fu_96_ap_start;
    sc_signal< sc_logic > grp_Filter2D_fu_96_ap_done;
    sc_signal< sc_logic > grp_Filter2D_fu_96_ap_idle;
    sc_signal< sc_logic > grp_Filter2D_fu_96_ap_ready;
    sc_signal< sc_logic > grp_Filter2D_fu_96_p_src_data_stream_V_read;
    sc_signal< sc_lv<16> > grp_Filter2D_fu_96_p_dst_data_stream_V_din;
    sc_signal< sc_logic > grp_Filter2D_fu_96_p_dst_data_stream_V_write;
    sc_signal< sc_logic > grp_Filter2D_fu_96_ap_start_reg;
    ...
    void thread_grp_Filter2D_fu_96_ap_start();
