...
Duplicate::Duplicate(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_125_fu_178_p1 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( t_V_cast_fu_186_p1 );

    SC_METHOD(thread_exitcond_fu_205_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( tmp_126_fu_182_p1 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( t_V_4_cast_fu_201_p1 );

    SC_METHOD(thread_i_V_fu_195_p2);
    sensitive << ( t_V_reg_156 );
    ...
    SC_METHOD(thread_t_V_4_cast_fu_201_p1);
    sensitive << ( t_V_4_reg_167 );

    SC_METHOD(thread_t_V_cast_fu_186_p1);
    sensitive << ( t_V_reg_156 );

    SC_METHOD(thread_tmp_125_fu_178_p1);
    sensitive << ( src_rows_V );

    SC_METHOD(thread_tmp_126_fu_182_p1);
    ...
    sc_trace(mVcdFile, exitcond_reg_235, "exitcond_reg_235");
    ...
    sc_trace(mVcdFile, t_V_4_reg_167, "t_V_4_reg_167");
    sc_trace(mVcdFile, tmp_125_fu_178_p1, "tmp_125_fu_178_p1");
    sc_trace(mVcdFile, ap_block_state1, "ap_block_state1");
    sc_trace(mVcdFile, tmp_126_fu_182_p1, "tmp_126_fu_182_p1");
    sc_trace(mVcdFile, exitcond7_fu_190_p2, "exitcond7_fu_190_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, i_V_fu_195_p2, "i_V_fu_195_p2");
    sc_trace(mVcdFile, i_V_reg_230, "i_V_reg_230");
    ...
    sc_trace(mVcdFile, t_V_reg_156, "t_V_reg_156");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, ap_block_pp0_stage0_01001, "ap_block_pp0_stage0_01001");
    sc_trace(mVcdFile, t_V_cast_fu_186_p1, "t_V_cast_fu_186_p1");
    sc_trace(mVcdFile, t_V_4_cast_fu_201_p1, "t_V_4_cast_fu_201_p1");
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(exitcond7_fu_190_p2.read(), ap_const_lv1_1))) {
...
void Duplicate::thread_ap_block_pp0_stage0_01001() {
    ap_block_pp0_stage0_01001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || 
  (esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || 
  (esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_state4_pp0_stage0_iter1() {
    ap_block_state4_pp0_stage0_iter1 = ((esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || (esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || (esl_seteq<1,1,1>(exitcond_reg_235.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst2_data_stream_V_full_n.read())));
}

void Duplicate::thread_ap_condition_pp0_exit_iter0_state3() {
    if (esl_seteq<1,1,1>(exitcond_fu_205_p2.read(), ap_const_lv1_1)) {
...
void Duplicate::thread_exitcond7_fu_190_p2() {
    exitcond7_fu_190_p2 = (!t_V_cast_fu_186_p1.read().is_01() || !tmp_125_fu_178_p1.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_cast_fu_186_p1.read() == tmp_125_fu_178_p1.read());
}

void Duplicate::thread_exitcond_fu_205_p2() {
    exitcond_fu_205_p2 = (!t_V_4_cast_fu_201_p1.read().is_01() || !tmp_126_fu_182_p1.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_4_cast_fu_201_p1.read() == tmp_126_fu_182_p1.read());
}

void Duplicate::thread_i_V_fu_195_p2() {
    i_V_fu_195_p2 = (!t_V_reg_156.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(t_V_reg_156.read()) + sc_biguint<11>(ap_const_lv11_1));
}
...
void Duplicate::thread_j_V_fu_210_p2() {
    j_V_fu_210_p2 = (!t_V_4_reg_167.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(t_V_4_reg_167.read()) + sc_biguint<11>(ap_const_lv11_1));
}
...
void Duplicate::thread_t_V_4_cast_fu_201_p1() {
    t_V_4_cast_fu_201_p1 = esl_zext<12,11>(t_V_4_reg_167.read());
}

void Duplicate::thread_t_V_cast_fu_186_p1() {
    t_V_cast_fu_186_p1 = esl_zext<12,11>(t_V_reg_156.read());
}

void Duplicate::thread_tmp_125_fu_178_p1() {
    tmp_125_fu_178_p1 = src_rows_V.read().range(12-1, 0);
}

void Duplicate::thread_tmp_126_fu_182_p1() {
    tmp_126_fu_182_p1 = src_cols_V.read().range(12-1, 0);
}
...
void Duplicate::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(exitcond7_fu_190_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
            ...
            break;
        case 4 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(exitcond_fu_205_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(exitcond_fu_205_p2.read(), ap_const_lv1_1))) {
