...
(* CORE_GENERATION_INFO="canny_edge,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.250000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=14,HLS_SYN_DSP=17,HLS_SYN_FF=3862,HLS_SYN_LUT=6081,HLS_VERSION=2018_3}" *)
...
input  [31:0] INPUT_data_V_TDATA;
output  [31:0] OUTPUT_data_V_TDATA;
input   INPUT_data_V_TVALID;
output   INPUT_data_V_TREADY;
output   OUTPUT_data_V_TVALID;
input   OUTPUT_data_V_TREADY;
...
wire    Block_Mat_exit27932_U0_ap_start;
wire    Block_Mat_exit27932_U0_ap_done;
wire    Block_Mat_exit27932_U0_ap_continue;
wire    Block_Mat_exit27932_U0_ap_idle;
wire    Block_Mat_exit27932_U0_ap_ready;
wire   [19:0] Block_Mat_exit27932_U0_packets_cast_out_out_din;
wire    Block_Mat_exit27932_U0_packets_cast_out_out_write;
...
wire    Loop_1_proc_U0_packets_cast_loc_read;
wire    Loop_1_proc_U0_in_stream_data_V_TREADY;
wire   [7:0] Loop_1_proc_U0_src_bw_data_stream_0_V_din;
wire    Loop_1_proc_U0_src_bw_data_stream_0_V_write;
wire   [19:0] Loop_1_proc_U0_packets_cast_loc_out_din;
wire    Loop_1_proc_U0_packets_cast_loc_out_write;
...
wire    nonmax_suppression_U0_start_out;
...
wire    Loop_2_proc_U0_packets_cast_loc_read;
wire    Loop_2_proc_U0_canny_edges_data_stream_0_V_read;
wire   [31:0] Loop_2_proc_U0_out_stream_data_V_TDATA;
wire    Loop_2_proc_U0_out_stream_data_V_TVALID;
wire    ap_sync_continue;
wire    packets_cast_loc_c_full_n;
wire   [19:0] packets_cast_loc_c_dout;
wire    packets_cast_loc_c_empty_n;
wire    src_bw_data_stream_0_full_n;
wire   [7:0] src_bw_data_stream_0_dout;
wire    src_bw_data_stream_0_empty_n;
wire    packets_cast_loc_c35_full_n;
wire   [19:0] packets_cast_loc_c35_dout;
wire    packets_cast_loc_c35_empty_n;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_Block_Mat_exit27932_U0_ap_ready;
wire    ap_sync_Block_Mat_exit27932_U0_ap_ready;
reg   [1:0] Block_Mat_exit27932_U0_ap_ready_count;
reg    ap_sync_reg_Loop_1_proc_U0_ap_ready;
wire    ap_sync_Loop_1_proc_U0_ap_ready;
reg   [1:0] Loop_1_proc_U0_ap_ready_count;
wire    Block_Mat_exit27932_U0_start_full_n;
wire    Block_Mat_exit27932_U0_start_write;
...
initial begin
#0 ap_sync_reg_Block_Mat_exit27932_U0_ap_ready = 1'b0;
#0 Block_Mat_exit27932_U0_ap_ready_count = 2'd0;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Block_Mat_exit27932_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Block_Mat_exit27932_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Block_Mat_exit27932_U0_ap_ready_count <= (Block_Mat_exit27932_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Block_Mat_exit27932_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Block_Mat_exit27932_U0_ap_ready_count <= (Block_Mat_exit27932_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit27932_U0_ap_continue = 1'b1;

assign Block_Mat_exit27932_U0_ap_start = ((ap_sync_reg_Block_Mat_exit27932_U0_ap_ready ^ 1'b1) & ap_start);

assign Block_Mat_exit27932_U0_start_full_n = 1'b1;

assign Block_Mat_exit27932_U0_start_write = 1'b0;
...
assign INPUT_data_V_TREADY = Loop_1_proc_U0_in_stream_data_V_TREADY;

assign Loop_1_proc_U0_ap_continue = 1'b1;

assign Loop_1_proc_U0_ap_start = ((ap_sync_reg_Loop_1_proc_U0_ap_ready ^ 1'b1) & ap_start);

assign Loop_1_proc_U0_start_full_n = (start_for_Loop_2_proc_U0_full_n & start_for_Duplicate_U0_full_n);
...
assign OUTPUT_data_V_TDATA = Loop_2_proc_U0_out_stream_data_V_TDATA;

assign OUTPUT_data_V_TVALID = Loop_2_proc_U0_out_stream_data_V_TVALID;
...
assign ap_idle = (nonmax_suppression_U0_ap_idle & hysteresis_U0_ap_idle & gradient_decompositi_U0_ap_idle & Sobel_U0_ap_idle & Sobel_1_U0_ap_idle & Loop_2_proc_U0_ap_idle & Loop_1_proc_U0_ap_idle & Duplicate_U0_ap_idle & Block_Mat_exit27932_U0_ap_idle);
...
assign ap_sync_Block_Mat_exit27932_U0_ap_ready = (ap_sync_reg_Block_Mat_exit27932_U0_ap_ready | Block_Mat_exit27932_U0_ap_ready);
...
assign ap_sync_ready = (ap_sync_Loop_1_proc_U0_ap_ready & ap_sync_Block_Mat_exit27932_U0_ap_ready);
